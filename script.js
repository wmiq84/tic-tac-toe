...
// console.log(playersInstance);
// console.log(playersInstance.playerOne);
console.log(game.checkWin(board));
// game.placePiece(1, 2, board, playersInstance.playerOne);
game.placePiece(1, 2, board, playerOne);

console.log(game.checkWin(board));
// game.placePiece(1, 3, board, playersInstance.playerOne);
game.placePiece(1, 3, board, playerOne);
console.log(game.checkWin(board));


// game.placePiece(1, 1, board, true);
